...
-- Execute ESTE bloco primeiro no Supabase
-- ============================================
...
-- ============================================
-- PASSO 2: CRIAR TABELAS NOVAS (com estrutura correta)
-- Execute TODO o código abaixo depois
-- ============================================

-- Enable UUID extension
CREATE EXTENSION IF NOT EXISTS "uuid-ossp";

-- Users (ID = Clerk User ID como TEXT, não UUID)
CREATE TABLE users (
  id TEXT PRIMARY KEY,
  email TEXT,
  name TEXT,
...
-- Projects (user_id como TEXT para referenciar Clerk ID)
...
CREATE INDEX idx_ai_threads_project_id ON ai_threads(project_id);
CREATE INDEX idx_ai_messages_thread_id ON ai_messages(thread_id);

-- ============================================
-- DESABILITAR RLS (usamos Clerk no backend)
-- ============================================
...
-- ============================================
-- PRONTO! Agora recarregue a página /projects
-- ============================================
